...
export const MapView = (props: Props) => {
  ...
  const isFreeRouteMode = props.routeClickMode === "free"

  return (
    <MapContainer center={CENTER} zoom={ZOOM} className="h-full w-full">
      <MapPanes />
      <MapInteractions
        routeClickMode={props.routeClickMode}
      ...
      {isFreeRouteMode && routePoints.length > 1 && (
        <Polyline positions={routePoints} weight={4} opacity={0.9} />
      )}
